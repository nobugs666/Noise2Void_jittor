...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights_path', type=str, default='weights/best_N2V_Unet_[30].pth')  # 最优模型文件
    ...
    parser.add_argument('--outputs_denoising_dir', type=str, default='data/BSD68_denoising_30_N2V_Unet')    # 去噪结果保存文件夹
    parser.add_argument('--outputs_plt_dir', type=str, default='data/BSD68_denoising_30_plt_N2V_Unet')  # 去噪结果可视化保存文件夹
    parser.add_argument('--gaussian_noise_level', type=str, default='30')   # 高斯噪声强度
